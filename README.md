...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create correla-f420
  fly apps create correla-f420-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app correla-f420
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app correla-f420-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'correla-f420-staging' does not match app name in config file 'correla-f420'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name correla-f420-db
  fly postgres attach --app correla-f420 correla-f420-db

  fly postgres create --name correla-f420-staging-db
  fly postgres attach --app correla-f420-staging correla-f420-staging-db
  ```
